...
function writeFile(localFileName, nameOnS3, binary) {
	...
	nameOnS3 = "week05bootstrap" + nameOnS3;
...
writeFile('CSS.png', '/CSS.png', false);
writeFile('Education.png', '/Education.png', false);
writeFile('Experience.png', '/Experience.png', false);
writeFile('favicon.png', '/favicon.png', false);
writeFile('Hobbies.png', '/Hobbies.png', false);
writeFile('HTML-Button.png', '/HTML-Button.png', false);
writeFile('md.png', '/md.png', false);
//listBuckets(s3);
