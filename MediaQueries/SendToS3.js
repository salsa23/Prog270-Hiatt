...
var bucketName = 'prog270.chelsahiatt';
...
function writeFile(localFileName, nameOnS3, binary) {
	...
	nameOnS3 = "week04mediaqueries" + nameOnS3;
...
//walkDirs('orgPNGs')
//walkDirs('screenshots');
//walkDirs('js');
writeFile('blueStyleLarge.css', '/blueStyleLarge.css', false);
writeFile('colorMeThree.css', '/colorMeThree.css', false);
writeFile('greenStyleMedium.css', '/greenStyleMedium.css', false);
writeFile('redStyleSmall.css', '/redStyleSmall.css', false);
//writeFile('index.css', '/index.css', false);
writeFile('Prog270Tables01-Hiatt.html', '/Prog270Tables01-Hiatt.html', false);
writeFile('Prog270Tables02-Hiatt.html', '/Prog270Tables02-Hiatt.html', false);
